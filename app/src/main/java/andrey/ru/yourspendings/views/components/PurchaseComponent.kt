...
class PurchaseComponent(override val context:MainActivity):ModelItemComponent(context) {
    ...
    override fun renderLayout(): LinearLayout {
        ...
        return super.renderLayout().apply {
            addView(TextView(context).apply { text = context.getString(R.string.images)},indexOfChild(buttonsContainer))
            ...
            addView(button(context.getString(R.string.take_a_picture))
    ...
    override fun renderForm(): TableLayout {
        return super.renderForm().apply {
            addView(renderLabelRow(context.getString(R.string.date)) { date = it }.apply {
                addView(selectButton().also { selectDateButton = it })
            })
            addView(renderLabelRow(context.getString(R.string.shop)) { place = it}. apply {
